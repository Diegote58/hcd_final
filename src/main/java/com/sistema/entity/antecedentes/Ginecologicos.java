...
public class Ginecologicos {
	...
	public String toString() {
		return "Ginecologicos [id_ginecologicos=" + id + ", FUM=" + FUM + ", FPP=" + FPP + ", edadGestacional="
				+ edadGestacional + ", menarca=" + menarca + ", RM=" + RM + ", IRS=" + IRS + ", nroParejas="
				+ nroParejas + ", flujoGenital=" + flujoGenital + ", gestas=" + gestas + ", partos=" + partos
				+ ", cesareas=" + cesareas + ", abortos=" + abortos + ", otros=" + descripcion + ", antecedentes="
				+ antecedentes + "]";
	}
